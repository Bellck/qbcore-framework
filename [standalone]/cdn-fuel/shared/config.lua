...
Config.CostMultiplier = 50 -- Amount to multiply 1 by. This indicates fuel price. (Default: $3.0/l or 3.0)
...
Config.Ox = {
    Inventory = "ps-inventory", -- Uses OX_Inventory's metadata instead of ps-inventory's.
